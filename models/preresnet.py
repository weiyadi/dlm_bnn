...
__all__ = ['PreResNet110', 'PreResNet56', 'PreResNet8', 'PreResNet83', 'PreResNet164',
           'PreResNet20', 'PreResNet20ImageNette', 'PreResNet20NoSkip', 'PreResNet20NoSkipImageNette',
           'PreResNet20NoAug'
           ]
...
class PreResNet20NoSkip:
    base = PreResNet
    args = list()
    kwargs = {'depth': 20, 'skip_connections': False}
    transform_train = transforms.Compose([
        transforms.Resize(32),
        transforms.RandomCrop(32, padding=4),
        transforms.RandomHorizontalFlip(),
...
class PreResNet20NoSkipImageNette:
    base = PreResNet
    args = list()
    kwargs = {'depth': 20, 'skip_connections': False, 'planes': [4, 8, 16], 'input_size': 160}
    transform_train = transforms.Compose([
        transforms.RandomCrop(160, padding=4),
        transforms.RandomHorizontalFlip(),
        transforms.ToTensor(),
