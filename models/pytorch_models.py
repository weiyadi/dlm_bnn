"""
Imported from https://github.com/izmailovpavel/neurips_bdl_starter_kit/blob/main/pytorch_models.py
"""
import torch
...
def make_cifar_alexnet(num_classes, *args, **kwargs):
    act = torch.nn.SiLU
    return nn.Sequential(
        ...
        act(),
        nn.MaxPool2d(2, stride=2, padding=0),
        nn.Conv2d(128, 256, kernel_size=2, padding="same"),  # padding?
        act(),
        nn.Conv2d(256, 128, kernel_size=2, padding="same"),  # padding?
        act(),
        nn.Conv2d(128, 64, kernel_size=2, padding="same"),  # padding?
        act(),
        nn.Flatten(),
        nn.Linear(4096, 256),
        act(),
